...
class GameHistory:
    ...
    def _init__(self, finished: bool, winnerPlayerNum: int, gameHistory: List[List[Trick]]):
...
class Player:
    ...
    def _init__(self, points: int, handSize: int):
...
class MatchState:
    ...
    def __init__(self, myPlayerNum: int, players: List[Player], myHand: List[str], toBeat: Trick, matchHistory: List[GameHistory], myData: str):
